...
public class InMemoryPersistenceServiceTest {
    ...
    @Test
    public void empty() {
        assertEquals(0, persistenceService.list(ORG_NAME, SOLUTION_ID).size());
        assertNull(persistenceService.retrieve(ORG_NAME, SOLUTION_ID, DOC_ID));
    }

    @Test
    public void insert() throws UpdateException {
        long revision = persistenceService.insert(ORG_NAME, SOLUTION_ID, new DocumentReference(DOC_ID, DOC_TYPE, 0), document);
        assertTrue(revision > 0);

        Collection<DocumentReference> documents = persistenceService.list(ORG_NAME, SOLUTION_ID);
        ...
        assertJsonEquals(document, persistenceService.retrieve(ORG_NAME, SOLUTION_ID, DOC_ID));

        assertNull(persistenceService.retrieve(ORG_NAME, SOLUTION_ID, NOT_THERE));
    }

    @Test
    public void insertConflict() throws UpdateException {
        persistenceService.insert(ORG_NAME, SOLUTION_ID, new DocumentReference(DOC_ID, DOC_TYPE, 0), document);
    ...
    public void insertSolutionSeparation() throws UpdateException {
        persistenceService.insert(ORG_NAME, "solution", new DocumentReference(DOC_ID, DOC_TYPE, 0), document);
        persistenceService.insert(ORG_NAME, "solvation", new DocumentReference(DOC_ID, DOC_TYPE, 0), document);

        Collection<DocumentReference> documents = persistenceService.list(ORG_NAME, "solution");
        assertEquals(1, documents.size());

        documents = persistenceService.list(ORG_NAME, "solvation");
        assertEquals(1, documents.size());
    }
    ...
    public void update() throws UpdateException {
        ...
        long newRevision = persistenceService.update(ORG_NAME, SOLUTION_ID, new DocumentReference(DOC_ID, DOC_TYPE, revision), document);
    ...
    public void updateConflict() throws UpdateException {
        ...
        try {
            persistenceService.update(ORG_NAME, SOLUTION_ID, new DocumentReference(DOC_ID, DOC_TYPE, revision-1), document);
    ...
    public void updateSolutionSeparation() throws UpdateException {
        long original = persistenceService.insert(ORG_NAME, "solution", new DocumentReference(DOC_ID, DOC_TYPE, 0), document);
        persistenceService.insert(ORG_NAME, "solvation", new DocumentReference(DOC_ID, DOC_TYPE, 0), document);
        long updated = persistenceService.update(ORG_NAME, "solvation", new DocumentReference(DOC_ID, DOC_TYPE, 1), document);
        assertEquals(original, persistenceService.list(ORG_NAME, "solution").iterator().next()._rev);
        assertEquals(2, updated);
    }
    ...
    public void delete() throws UpdateException {
        ...
        persistenceService.delete(ORG_NAME, SOLUTION_ID, new DocumentReference(DOC_ID, DOC_TYPE, revision));
    ...
    public void deleteConflict() throws UpdateException {
        ...
        try {
            persistenceService.delete(ORG_NAME, SOLUTION_ID, new DocumentReference(DOC_ID, DOC_TYPE, revision-1));
            fail("should throw UpdateException(PRECONDITION_FAILED)");
        } catch (UpdateException e) {
            assertEquals(HttpStatus.PRECONDITION_FAILED, e.getStatusCode());
        }
    ...
    public void deleteSolutionSeparation() throws UpdateException {
        persistenceService.insert(ORG_NAME, "solution", new DocumentReference(DOC_ID, DOC_TYPE, 0), document);
        long revision = persistenceService.insert(ORG_NAME, "solvation", new DocumentReference(DOC_ID, DOC_TYPE, 0), document);
        persistenceService.delete(ORG_NAME, "solvation", new DocumentReference(DOC_ID, DOC_TYPE, revision));
